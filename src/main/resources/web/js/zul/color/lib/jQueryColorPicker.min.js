...
!function (a, b) {
    ...
    function c(a, c, d, f, g) {
        ...
        } else if (c)for (var h in c)a[d][h] = "Lab" === d ? k(c[h], l[d][h][0], l[d][h][1]) : k(c[h] / l[d][h][1], 0, 1);
    ...
    function d(a, b, c) {
        ...
        return e.RGB = {r: a.r, g: a.g, b: a.b}, e.rgb = {
            ...
            g: b.g,
            b: b.b
        }, e.alpha = c, e.equivalentGrey = r.round(d.r * a.r + d.g * a.g + d.b * a.b), e.rgbaMixBlack = i(b, {
            r: 0,
            g: 0,
            b: 0
    ...
    function e(a, b) {
        var c, e, k, o = r, p = b || n, q = v, s = m.options, t = l, u = p.RND, w = "", x = "", y = {
            hsl: "hsv",
            cmyk: "cmy",
            rgb: a
        }, z = u.rgb;
        if ("alpha" !== a) {
            for (var A in t)if (!t[A][A]) {
                a !== A && "XYZ" !== A && (x = y[A] || "rgb", p[A] = q[x + "2" + A](p[x])), u[A] || (u[A] = {}), c = p[A];
                for (w in c)u[A][w] = o.round(c[w] * ("Lab" === A ? 1 : t[A][w][1]))
            }
    ...
    function g(a, b, c) {
        var d = r;
        return (d.max(a.r - b.r, b.r - a.r) + d.max(a.g - b.g, b.g - a.g) + d.max(a.b - b.b, b.b - a.b)) * (c ? 255 : 1) / 765
    }

    function h(a, b) {
        for (var c = b ? 1 : 255, d = [a.r / c, a.g / c, a.b / c], e = m.options.luminance, f = d.length; f--;)d[f] = d[f] <= .03928 ? d[f] / 12.92 : r.pow((d[f] + .055) / 1.055, 2.4);
    ...
    function j(a, b) {
        var c = 1;
        return c = a >= b ? (a + .05) / (b + .05) : (b + .05) / (a + .05), r.round(100 * c) / 100
    }
    ...
    var l = {
    ...
    }, p = {r: .298954, g: .586434, b: .114612}, q = {
        r: .2126,
        g: .7152,
        b: .0722
    }, r = a.Math, s = (a.parseInt, a.Colors = function (a) {
        ...
        e = g.XYZMatrix, d.XYZReference || (g.XYZReference = {
            ...
            Y: e.Y[0] + e.Y[1] + e.Y[2],
            Z: e.Z[0] + e.Z[1] + e.Z[2]
        }), f = g.customBG, g.customBG = "string" == typeof f ? v.txt2color(f).rgb : f, n = c(a.colors, g.color, b, !0)
    }, u = function (a) {
        m !== a && (m = a, n = a.colors)
    };
    s.prototype.setColor = function (a, d, f) {
        ...
        var c = v, d = l, e = b.split("2"), f = e[0], g = e[1], h = /(?:RG|HS|CM|LA)/, i = h.test(f), j = h.test(g), k = {LAB: "Lab"}, m = function (a, b, c) {
            var e = {}, f = "Lab" === b ? 1 : 0;
            for (var g in a)e[g] = c ? r.round(a[g] * (f || d[b][g][1])) : a[g] / (f || d[b][g][1]);
            return e
        };
    ...
    var v = {
        txt2color: function (a) {
            ...
            if (b.type = e, b[e] = {}, c[1])for (var g = 3; g--;)f = e[g] || e.charAt(g), b[e][f] = +d[g] / l[e][f][1]; else b.rgb = v.HEX2rgb(c[0]);
            return b.alpha = d[3] ? +d[3] : 1, b
        }, color2text: function (a, b, c) {
            var d = c !== !1 && r.round(100 * b.alpha) / 100, e = "number" == typeof d && c !== !1 && (c || 1 !== d), f = b.RND.rgb, g = b.RND.hsl, h = "hex" === a && e, i = "hex" === a && !h, j = "rgb" === a || h, k = j ? f.r + ", " + f.g + ", " + f.b : i ? "#" + b.HEX : g.h + ", " + g.s + "%, " + g.l + "%";
            ...
            return h > g && (g = h + (h = g, 0), i = -1), c = h, g > f && (f = g + (g = f, 0), i = -2 / 6 - i, c = e.min(g, h)), b = f - c, d = f ? b / f : 0, {
                h: 1e-15 > d ? n && n.hsl && n.hsl.h || 0 : b ? e.abs(i + (g - h) / (6 * b)) : 0,
                s: f ? b / f : n && n.hsv && n.hsv.s || 0,
                v: f
            }
        }, hsv2rgb: function (a) {
            ...
            var c = r, d = m.options.XYZMatrix, e = a.X, f = a.Y, g = a.Z, h = e * d.R[0] + f * d.R[1] + g * d.R[2], i = e * d.G[0] + f * d.G[1] + g * d.G[2], j = e * d.B[0] + f * d.B[1] + g * d.B[2], l = 1 / 2.4;
            return d = .0031308, h = h > d ? 1.055 * c.pow(h, l) - .055 : 12.92 * h, i = i > d ? 1.055 * c.pow(i, l) - .055 : 12.92 * i, j = j > d ? 1.055 * c.pow(j, l) - .055 : 12.92 * j, b || (n._rgb = {
                r: h,
                g: i,
                b: j
            }), {r: k(h, 0, 1), g: k(i, 0, 1), b: k(j, 0, 1)}
        }, rgb2XYZ: function (a) {
            var b = r, c = m.options.XYZMatrix, d = a.r, e = a.g, f = a.b, g = .04045;
            return d = d > g ? b.pow((d + .055) / 1.055, 2.4) : d / 12.92, e = e > g ? b.pow((e + .055) / 1.055, 2.4) : e / 12.92, f = f > g ? b.pow((f + .055) / 1.055, 2.4) : f / 12.92, {
                X: d * c.X[0] + e * c.X[1] + f * c.X[2],
                Y: d * c.Y[0] + e * c.Y[1] + f * c.Y[2],
                Z: d * c.Z[0] + e * c.Z[1] + f * c.Z[2]
            }
        }, XYZ2Lab: function (a) {
            var b = r, c = m.options.XYZReference, d = a.X / c.X, e = a.Y / c.Y, f = a.Z / c.Z, g = 16 / 116, h = 1 / 3, i = .008856, j = 7.787037;
            return d = d > i ? b.pow(d, h) : j * d + g, e = e > i ? b.pow(e, h) : j * e + g, f = f > i ? b.pow(f, h) : j * f + g, {
                L: 116 * e - 16,
                a: 500 * (d - e),
                b: 200 * (e - f)
            }
        }, Lab2XYZ: function (a) {
            var b = r, c = m.options.XYZReference, d = (a.L + 16) / 116, e = a.a / 500 + d, f = d - a.b / 200, g = b.pow(e, 3), h = b.pow(d, 3), i = b.pow(f, 3), j = 16 / 116, k = .008856, l = 7.787037;
            return {
                X: (g > k ? g : (e - j) / l) * c.X,
                Y: (h > k ? h : (d - j) / l) * c.Y,
                Z: (i > k ? i : (f - j) / l) * c.Z
    ...
    function f(a) {
        ...
        return P ? a.color.options.devPicker : (document.getElementById("colorPickerCSS") ? a.cssIsReady = !0 : (g.onload = g.onerror = function () {
    ...
    function h(c, f) {
        ...
        g(cb.colorPicker, "mousedown", function (f) {
            var g = f || a.event, h = E(g), n = (g.button || g.which) < 2 ? g.target || g.srcElement : {}, o = n.className;
            return d(c), J = n, i(b, "resetEventListener"), U = "", n === cb.sldl_3 || n === cb.curm ? (J = cb.sldl_3, I = j, U = "changeXYValue", C(cb.slds, "do-drag")) : /sldr/.test(o) || n === cb.curl || n === cb.curr ? (J = cb.sldr_4, I = k, U = "changeZValue") : n === cb.opacity.children[0] || n === cb.opacity_slider ? (J = cb.opacity, I = l, U = "changeOpacityValue") : /-disp/.test(o) && !/HEX-/.test(o) ? (I = m, U = "changeInputValue", (3 === n.nextSibling.nodeType ? n.nextSibling.nextSibling : n.nextSibling).appendChild(cb.nsarrow), K = o.split("-disp")[0].split("-"), K = {
                ...
                pageX: h.X,
                pageY: h.Y
            }, J.style.display = "block", X = D(J), X.width = cb.opacity.offsetWidth, X.childWidth = cb.opacity_slider.offsetWidth, J.style.display = "", I(g), F(Q ? document.body : a, "mousemove", I), L = a[fb](w)), /-disp/.test(o) ? void 0 : B(g)
    ...
    function l(b) {
        ...
        return Y = !0, ab.alpha = z(db.round((d.X - X.left) / X.width * 100), 0, 100) / 100, t("alpha"), B(c)
    }
    ...
    function E(b) {
        var c = a.document;
        return {
            X: b.pageX || b.clientX + c.body.scrollLeft + c.documentElement.scrollLeft,
            Y: b.pageY || b.clientY + c.body.scrollTop + c.documentElement.scrollTop
        }
    }
    ...
    var I, J, K, L, M, N, O = a.ColorPicker, P = !O, Q = !1, R = !1, S = {}, T = {
        w: "White",
        b: "Black",
        c: "Custom"
    }, U = "", V = 1, W = {}, X = {}, Y = !0, Z = {}, $ = {}, _ = {}, ab = {}, bb = {}, cb = {}, db = Math, eb = "AnimationFrame", fb = "request" + eb, gb = "cancel" + eb, hb = ["ms", "moz", "webkit", "o"], ib = function (a) {
        this.options = {
            color: "rgba(204, 82, 37, 0.8)",
            mode: "rgb-b",
            fps: 60,
    ...
    for (var jb = hb.length; jb-- && !a[fb];)a[fb] = a[hb[jb] + "Request" + eb], a[gb] = a[hb[jb] + "Cancel" + eb] || a[hb[jb] + "CancelRequest" + eb];
    ...
    a.fn.extend({
        colorPicker: function (c) {
            var d = function (b, c) {
                var d = this, e = a(d.input), f = a(d.patch), g = (b.RND.rgb, b.RND.hsl, d.isIE8 ? (b.alpha < .16 ? "0" : "") + Math.round(100 * b.alpha).toString(16).toUpperCase() + b.HEX : ""), h = 1 !== b.alpha && !d.isIE8, i = e.data("colorMode");
                d._instance && (f.css({
                    color: b.rgbaMixCustom.luminance > .22 ? "#222" : "#ddd",
                    "background-color": d._instance.toString(),
                    filter: d.isIE8 ? "progid:DXImageTransform.Microsoft.gradient(startColorstr=#" + g + ",endColorstr=#" + g + ")" : ""
                }), e.val("HEX" !== i || h ? d._instance.toString(i, d.forceAlpha) : "#" + (d.isIE8 ? g : b.HEX)), d.displayCallback && d.displayCallback(b, c, d))
            }, e = function (a) {
                return a.value || a.getAttribute("value") || a.style.backgroundColor || "#FFFFFF"
            }, f = function (b, c) {
                var d = this, e = j.current;
                if ("toMemory" === c) {
                    for (var f, g = e.nodes.memos, h = "", i = 0, k = [], l = 0, m = g.length; m > l; l++)f = a(g[l]), h = f.css("background-color"), i = Math.round(100 * f.css("opacity")) / 100, k.push(h.replace(/, /g, ",").replace("rgb(", "rgba(").replace(")", "," + i + ")"));
                    k = "'" + k.join("','") + "'", a.docCookies("colorPickerMemos" + (d.noAlpha ? "NoAlpha" : ""), k)
                } else if ("resizeApp" === c)a.docCookies("colorPickerSize", e.color.options.currentSize); else if ("modeChange" === c) {
                ...
                var h, i = {
                    ...
                    memoryColors: a.docCookies("colorPickerMemos" + ((g || {}).noAlpha ? "NoAlpha" : "")),
                    size: a.docCookies("colorPickerSize") || 1,
                    renderCallback: d,
                    actionCallback: f
                };
                for (var j in g)i[j] = g[j];
                return h = new i.klass(i), h.color.options._instance = h.color, h
            }, h = function (d, f, h) {
                var k = h ? "off" : "on";
                a(d)[k]("focus.colorPicker", function () {
                    var b = a(this), h = b.offset(), k = f ? a(i).index(this) : 0, l = j[k] || (j[k] = g(this, c)), m = l.color.options, n = a.ui && m.draggable ? a(l.nodes.colorPicker).draggable({cancel: "." + m.CSSPrefix + "app div"}) : a(l.nodes.colorPicker), o = a(m.appendTo || document.body), p = /static/.test(o.css("position")), q = p ? {
                        left: 0,
                        top: 0
                    } : o[0].getBoundingClientRect(), r = 0;
                    m.color = e(d), n.css({
                        position: "absolute",
                        left: h.left + m.margin.left - q.left,
                        top: h.top + b.outerHeight(!0) + m.margin.top - q.top
                    }), f || (m.input = d, m.patch = d, l.setColor(e(d), void 0, void 0, !0), l.saveAsBackground()), j.current = j[k], o.append(n), r = setInterval(function () {
                        j.current.cssIsReady && (r = clearInterval(r), n.show(l.color.options.animationSpeed))
                    }, 10)
                }), a(b)[k]("mousedown.colorPicker", function (b) {
                    var c = j.current, d = a(c ? c.nodes.colorPicker : void 0), e = c ? c.color.options.animationSpeed : 0, f = a(b.target).closest(".cp-app")[0], g = a(i).index(b.target);
                    f && c && a(j).index(f) ? b.target === c.nodes.exit && (d.hide(e), a(":focus").trigger("blur")) : -1 !== g || d.hide(e)
                })
            }, i = this, j = a.fn.colorPicker.colorPickers || [], k = new b.Colors({
                customBG: c && c.customBG || "#FFFFFF",
                allMixDetails: !0
            });
            return a.fn.colorPicker.colorPickers = j, a(this).each(function (d, f) {
                if (a(f).off(".colorPicker"), a(b).off(".colorPicker"), "destroy" !== c) {
                    var g = e(f), i = g.split("(");
                    a(f).data("colorMode", i[1] ? i[0].substr(0, 3) : "HEX"), h(f, c && c.multipleInstances, !1), c && c.readOnly && (f.readOnly = !0), k.setColor(g), c && c.init && c.init(f, k.colors)
                }
            }), this
        }
